module ActsAsCriteria 
  module FormHelper
    ...
    def acts_as_criteria_select_user_filters(current_user, text = "select_existing", path = nil, autosubmit = true)
      path ||= send("search_#{controller_name}_path")
      ...
      onchange = autosubmit == true ? "document.location = '#{path}?' + this.value" : ""
